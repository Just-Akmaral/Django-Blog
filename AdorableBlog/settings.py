"""
Django settings for AdorableBlog project.
...
SECRET_KEY = '^s8+42z_6pw0j^rd2yt5b8n97q+gqmd$vv$dbv_%b!qt)^7ac_'
...
ROOT_URLCONF = 'AdorableBlog.urls'
...
WSGI_APPLICATION = 'AdorableBlog.wsgi.application'
